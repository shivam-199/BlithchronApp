...
import {Image, Text, View, StyleSheet, Platform, ScrollView, Pressable, Linking} from 'react-native';
...
_renderItem({item,index}){
  return (
    <View style={{
      ...
      <Text>{item.text}</Text> */}
      <Icon size={84} name="lock" color="white" style={{alignSelf:"center",marginTop:"10%"}} />
    ...
    return (
      ...
      <ScrollView style={ScreenStyle.root}>
        <View style={{paddingTop:20}}>
          ...
          {/* BLITHCHRON  text*/}
          <LinearTextGradient style={styles.textGradientStyle}  colors={['#41ABFE','#9460F1','#F5375C']} locations={[0,0.5,1]}>
            <Text style={styles.blithTitle}>
              Blithchron
            </Text>
          </LinearTextGradient>

          <LinearTextGradient style={styles.textGradientStyle}  colors={['#41ABFE','#9460F1','#F5375C']} locations={[0,0.5,1]}>
            <Text style={styles.blithSubTitle}>
        ...
        <View style={styles.CALeaderboardView}>
            ...
            <Text style={styles.CALeaderboardTitle}>
              CA Leaderboard
            </Text>
            ...
            <View style={styles.CALeaderboardBoard}>
              ...
              <View style={styles.CALeaderboardRank1}>
                <View style={{alignSelf:"center"}}>
                  ...
                  <Icon name="chevron-down" style={{color:"white", fontSize:25}}></Icon>
                </View>

                <IonIcon name="person" style={{fontSize:80, color:"white"}}></IonIcon>
             ...
             <View style={styles.buttonBackgroundStyle}> 
                <Button title="Know More" onPress={ ()=>{ Linking.openURL('https://google.com')}} />
            </View>
        ...
        <View style={styles.connectWithUs}>
          ...
          <View style={styles.socialLogos}>
              ...
              <Pressable onPress={ ()=>{ Linking.openURL('https://www.instagram.com/blithchron_iitgn/')}}>
                <IonIcon name="logo-instagram" style={{fontSize:30, color:"white", marginLeft:45}} ></IonIcon>
              </Pressable>

              <Pressable onPress={ ()=>{ Linking.openURL('https://www.facebook.com/Blithchron')}}>
                <IonIcon name="logo-facebook" style={{fontSize:30, color:"white"}}></IonIcon>
              </Pressable>

              <Pressable onPress={ ()=>{ Linking.openURL('https://www.youtube.com/user/IITGnBlithchron')}}>
                <IonIcon name="logo-youtube" style={{fontSize:30, color:"white"}}></IonIcon>
              </Pressable>
              
              <Pressable onPress={ ()=>{ Linking.openURL('https://blithchron.iitgn.ac.in/')}}>
                <IonIcon name="globe-outline" style={{fontSize:30, color:"white",marginRight:45}}></IonIcon>
              </Pressable>
